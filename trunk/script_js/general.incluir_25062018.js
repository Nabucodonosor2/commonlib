...
function dlg_find_num(ve_nom_header, ve_valor_filtro1, ve_valor_filtro2, ve_cant_decimal, ve_solo_positivos, ve_campo)
{
	var id_campo = ve_campo.id;
	var url = "../../../../commonlib/trunk/php/dlg_find_num.php?nom_header="+URLEncode(ve_nom_header)+"&valor_filtro1="+URLEncode(ve_valor_filtro1)+"&valor_filtro2="+URLEncode(ve_valor_filtro2)+"&cant_decimal="+ve_cant_decimal+"&solo_positivos="+ve_solo_positivos;
	$.showModalDialog({
		 url: url,
		 dialogArguments: '',
		 height: 170,
