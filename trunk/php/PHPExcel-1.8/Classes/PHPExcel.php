...
//echo session::get('K_ROOT_DIR'); return false;
if (!defined('PHPEXCEL_ROOT')) {
    define('PHPEXCEL_ROOT', session::get('K_ROOT_DIR'));
    //require(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Autoloader.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Calculation.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Worksheet.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Calculation/Function.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/DocumentProperties.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/DocumentSecurity.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Style.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/Cell.php');
    require_once(PHPEXCEL_ROOT . '../../commonlib/trunk/php/PHPExcel-1.8/Classes/PHPExcel/WorksheetIterator.php');
}
